...
exports.getFiles = function (container, options, callback) {
  ...
  this._xmlRequest({
    ...
    var blobs = (body.Blobs && body.Blobs.Blob) || (body.EnumerationResults && body.EnumerationResults.Blobs && body.EnumerationResults.Blobs.Blob);
    if (blobs) {
      return callback(null, self._toArray(blobs).map(function (file) {
